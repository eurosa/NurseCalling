...
{
    public class RoundPanelWithoutTitle : GroupBox
    {

        public RoundPanelWithoutTitle()
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (var path = GetRoundRectagle(this.ClientRectangle, Radious))
            {
                ...
                e.Graphics.SmoothingMode = SmoothingMode.HighQuality;// SmoothingMode.AntiAlias;
                rect = new Rectangle(0, 0,
                    rect.Width, rect.Height + Padding.Bottom + Padding.Top);
